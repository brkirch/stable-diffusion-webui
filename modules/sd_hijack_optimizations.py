...
def upcast_attn():
    return shared.opts.upcast_attn == "Automatic" and devices.attn_needs_upcast or shared.opts.upcast_attn == "Enabled"
...
def split_cross_attention_forward_v1(self, x, context=None, mask=None, **kwargs):
    ...
    with devices.without_autocast(disable=not upcast_attn()):
