...
checkpoints_list = {}
checkpoints_list_prev = None
list_models_lock = threading.Lock()
checkpoint_aliases = {}
checkpoint_aliases_prev = None
...
def list_models():
    ...
    with list_models_lock:
        try:
            checkpoints_list_prev = checkpoints_list.copy()
            checkpoint_aliases_prev = checkpoint_aliases.copy()
